...
// Env
// -----------------------------------------------------------------------------
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/go-pwa","GOAPP_STATIC_RESOURCES_URL":"/go-pwa","GOAPP_VERSION":"5773511354fe5ff79fbf179cb62ca4232d46e3ed"};
...
if (!/bot|googlebot|crawler|spider|robot|crawling/i.test(navigator.userAgent)) {
  ...
  WebAssembly.instantiateStreaming(fetch("/go-pwa/web/app.wasm"), go.importObject)
    .then(result => {
